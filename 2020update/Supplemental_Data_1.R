...
#activate this
#write_csv(TrainingPoints,"TrainingPoints20.csv")
...
#ModelOutput.Final=read_csv("ModelOutput.Final_20.csv")
...
#                                            ))))))
MaxClass_Final_20_50uncertain=ModelOutput.All%>%
  select(GoodeR.ID)%>%
  bind_cols(MaxClass)%>%
...
#
# say("Outputting initial class selections to MaxClass_Final_20_50uncertain.csv")
# 
# write_csv(MaxClass_Final_20_50uncertain,"MaxClass_Final_20_50uncertain.csv")
#----
...
say("Writing initial class selections to Goode_FinalClassification_20_50uncertain.tiff")

rastOut(MaxClass_Final, "./R_FinalOutputs/Goode_FinalClassification_20_50uncertain.tif", "Class")
...
rastOut(MaxClass_Final, "./R_FinalOutputs/Goode_FinalClassification_20_Excludeduncertain.tif", "Class")
...
LossClassified=temp%>%
  left_join(MaxClass_Final_20_50uncertain,by="GoodeR.ID")%>%
  filter(Class!=0)
...
Goode_FinalClassification20_Expand_05pcnt=temp
writeRaster(Goode_FinalClassification20_Expand_05pcnt, filename = "R_FinalOutputs/TestMask.tif", type="GTIFF", overwrite = TRUE)

write_csv(Goode_FinalClassification20_Expand_05pcnt,"FinalClass_20_05pcnt.csv")
#-----
...
#FinalClass_20 = read_csv("./FinalClass_20_05pcnt.csv", col_types = cols(Class.Final = col_integer()))
FinalClass_20 = Goode_FinalClassification20_Expand_05pcnt
...
LossData=GoodeR_SecondaryData%>%
  ...
  ungroup()%>%
  left_join(FinalClass_20,by="GoodeR.ID")

LossMask_20_Deforestation=LossData%>%
  filter(Class.Final==1)
write_csv(LossMask_20_Deforestation,"LossMask_20_Deforestation.csv")
rastOut(LossMask_20_Deforestation, "LossMask_20_Deforestation.tif", Loss_10kMean_20002016)

LossMask_20_Shifting.Agriculture=LossData%>%
  filter(Class.Final==2)
write_csv(LossMask_20_Shifting.Agriculture,"LossMask_20_Shifting.Agriculture.csv")
rastOut(LossMask_20_Shifting.Agriculture, "LossMask_20_Shifting.Agriculture.tif", Loss_10kMean_20002016)

LossMask_20_Forestry=LossData%>%
  filter(Class.Final==3)
write_csv(LossMask_20_Forestry,"LossMask_20_Forestry.csv")
rastOut(LossMask_20_Forestry, "LossMask_20_Forestry.tif", Loss_10kMean_20002016)

LossMask_20_Wildfire=LossData%>%
  filter(Class.Final==4)
write_csv(LossMask_20_Wildfire,"LossMask_20_Wildfire.csv")
rastOut(LossMask_20_Wildfire, "LossMask_20_Wildfire.tif", Loss_10kMean_20002016)

LossMask_20_Urban=LossData%>%
  filter(Class.Final==5)
write_csv(LossMask_20_Urban,"LossMask_20_Urban.csv")
rastOut(LossMask_20_Urban, "LossMask_20_Urban.tif", Loss_10kMean_20002016)

LossMask_20_MinorLoss=LossData%>%
  filter(Class.Final==0)
write_csv(LossMask_20_MinorLoss,"LossMask_20_MinorLoss.csv")
rastOut(LossMask_20_MinorLoss, "LossMask_20_MinorLoss.tif", Loss_10kMean_20002016)
#---

#---------------------
# Final Class _20 Raster export
#---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="R_FinalOutputs/Goode_FinalClassification_20_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# 
# 
# #---------------------
# # LossMask_20_Deforestation Raster export
# #---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
#   left_join(LossMask_20_Deforestation,by="GoodeR.ID")%>%
#   select(GoodeR.ID,Loss_10kMean_20002016)
# names(data)=c("GoodeR.ID","data")
# list=data%>%
#   select(data)
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_LossMask_20_Deforestation_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# #----
# 
# #---------------------
# # LossMask_20_Shifting.Agriculture Raster export
# #---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
#   left_join(LossMask_20_Shifting.Agriculture,by="GoodeR.ID")%>%
#   select(GoodeR.ID,Loss_10kMean_20002016)
# names(data)=c("GoodeR.ID","data")
# list=data%>%
#   select(data)
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_LossMask_20_Shifting.Agriculture_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# #----
# 
# #---------------------
# # LossMask_20_Forestry Raster export
# #---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
#   left_join(LossMask_20_Forestry,by="GoodeR.ID")%>%
#   select(GoodeR.ID,Loss_10kMean_20002016)
# names(data)=c("GoodeR.ID","data")
# list=data%>%
#   select(data)
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_LossMask_20_Forestry_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# #----
# 
# #---------------------
# # LossMask_20_Wildfire Raster export
# #---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
#   left_join(LossMask_20_Wildfire,by="GoodeR.ID")%>%
#   select(GoodeR.ID,Loss_10kMean_20002016)
# names(data)=c("GoodeR.ID","data")
# list=data%>%
#   select(data)
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_LossMask_20_Wildfire_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# #----
# 
# #---------------------
# # LossMask_20_Urban Raster export
# #---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
#   left_join(LossMask_20_Urban,by="GoodeR.ID")%>%
#   select(GoodeR.ID,Loss_10kMean_20002016)
# names(data)=c("GoodeR.ID","data")
# list=data%>%
#   select(data)
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_LossMask_20_Urban_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# #----
# 
# #---------------------
# # LossMask_20_MinorLoss Raster export
# #---------------------
# data=1:6961896%>%
#   as.data.frame()%>%
#   rename("GoodeR.ID"=".")%>%
#   left_join(LossMask_20_MinorLoss,by="GoodeR.ID")%>%
#   select(GoodeR.ID,Loss_10kMean_20002016)
# names(data)=c("GoodeR.ID","data")
# list=data%>%
#   select(data)
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_LossMask_20_MinorLoss_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# #----
...
# 
# FinalClass_20=read_csv("FinalClass_20_05pcnt.csv", col_types = cols(Class.Final = col_number()))
# 
# #---------------------
# # add strata field #
# #---------------------
# 
# MaxClass_Final=FinalClass_20%>%
...
# 
# 
# write_csv(StrataCount,"StrataCount_20.csv")
# 
# #---------------------
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_Strata_All_20.tiff",type="GTIFF",overwrite=TRUE)
# #----
# 
# 
# #---------------------
...
# 
# 
# write_csv(Strata.Sample.Final,"Strata.Sample.Final_20_05pcnt.csv")
# 
...
# crs(r) = "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +" 
# plot(r)
# writeRaster(r,filename="Goode_Strata_SampleCells_StrataSampleID_20_05pcnt.tiff",type="GTIFF",overwrite=TRUE)
# 
...
# #---------------------
# 
# polygon <- readOGR(".", "StrataSampleID_Cells_20_05pcnt_sort")
...
# writeOGR(polygon2, dsn="SampleID_RegionStrata_20_1503_sort.kml", layer="polygon", driver="KML",overwrite=TRUE)
# 
# #----
# # Create KML
# 
# polygon <- readOGR(".", "SampleCell_Loss250m_RegionStrata_20_05pcnt")
# crs(polygon)= "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +"  
# 
# polygon2=spTransform(polygon,CRS("+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0"))
# writeOGR(polygon2, dsn="SampleCell_Loss250m_RegionStrata_20_05pcnt.kml", layer="polygon", driver="KML")
# 
# #----
# # Create Training KML
# 
# polygon <- readOGR(".", "TrainingCell_Loss250m_20")
# crs(polygon)= "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +"  
# 
# polygon2=spTransform(polygon,CRS("+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0"))
# writeOGR(polygon2, dsn="TrainingCellsClass17.kml", layer="polygon", driver="KML", overwrite=TRUE)
# 
# polygon <- readOGR(".", "TrainingCellsClass_20")
# crs(polygon)= "+proj=igh +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +ellps=WGS84 +units=m +"  
# 
# polygon2=spTransform(polygon,CRS("+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0"))
# writeOGR(polygon2, dsn="TrainingCellsClass_20.kml", layer="polygon", driver="KML", overwrite=TRUE)
